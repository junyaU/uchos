...
on_timer_interrupt:
    ...
    ; コンテキストがスイッチされなかった場合のみ実行
    jmp common_pop_and_restore

extern switch_task_by_interrupt
global interrupt_task_switch ; void interrupt_task_switch(void)
interrupt_task_switch:
    push rbp
    mov rbp, rsp
