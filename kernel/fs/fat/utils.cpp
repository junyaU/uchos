...
void send_read_req_to_blk_device(unsigned int sector, size_t len,
                                 MsgType dst_type, fs_id_t request_id,
                                 size_t sequence) {
...
void send_write_req_to_blk_device(void *buffer, unsigned int sector, size_t len,
                                  MsgType dst_type, fs_id_t request_id,
                                  size_t sequence) {
...
void write_fat_sectors_fallback(unsigned int base_sector, size_t start_sector,
                                size_t end_sector) {
...
void write_fat_sectors_chunked(unsigned int base_sector,
...
void send_file_data(fs_id_t id, void *buf, size_t size, ProcessId requester,
                    MsgType type, bool for_user) {
