...
constexpr uint32_t ATTR_ARCHIVE =
		0x00000020; ///< Archive bit (modified since last backup)
constexpr uint32_t ATTR_NORMAL =
		0x00000080; ///< Normal file with no other attributes
