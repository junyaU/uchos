...
sudo mkdir -p $storage_mount_point/EFI/BOOT

sudo cp ~/edk2/Build/${loader_pkg_name}X64/DEBUG_CLANG38/X64/UchLoaderPkg/Loader/OUTPUT/Loader.efi ${mount_point}/EFI/BOOT
sudo cp ~/edk2/Build/${loader_pkg_name}X64/DEBUG_CLANG38/X64/UchLoaderPkg/Loader/OUTPUT/Loader.efi ${storage_mount_point}/EFI/BOOT
